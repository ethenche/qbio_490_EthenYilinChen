...
string_var <- "any text value"
char_var <- 'enclosed in single quote'
...
var_age <- 18
var_age
var_birthday <- "08/11/2006"
var_birthday
var_three_fav_colors <- "blue, yellow, red"
var_three_fav_colors
typeof(var_name)
typeof(var_age)
typeof(var_birthday)
typeof(var_three_fav_colors)
